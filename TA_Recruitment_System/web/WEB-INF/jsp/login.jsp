        ...
        <section class="auth-brand">
            <div class="auth-brand-mark" aria-hidden="true">
                <svg viewBox="0 0 180 180" role="img">
                    <defs>
                        <linearGradient id="brandBlueUser" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <path d="M90 28 L145 52 L125 63 C115 58 103 55 90 55 C77 55 65 58 55 63 L35 52 Z" fill="url(#brandBlueUser)"/>
                    ...
                    <path d="M90 62 C122 62 148 88 148 120 C148 133 144 144 137 154 L137 170 L121 161 C112 167 101 170 90 170 C58 170 32 144 32 112 C32 80 58 62 90 62 Z" fill="#ffffff" stroke="url(#brandBlueUser)" stroke-width="8" stroke-linejoin="round"/>
                    <circle cx="90" cy="104" r="18" fill="url(#brandBlueUser)"/>
                    <path d="M62 145 C67 129 79 121 90 121 C101 121 113 129 118 145 Z" fill="url(#brandBlueUser)"/>
                </svg>
            </div>
            <div class="auth-brand-text">
                <div class="auth-brand-word">TAHub</div>
                <p class="auth-brand-subtitle auth-brand-subtitle-wide">
                    TA Recruitment System for<br>
